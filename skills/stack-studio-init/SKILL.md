...
2. Make sure the other stack-studio skills are in your context. If you don't see `name: create-stack` in your context anywhere, then you don't have them available yet, and you should run either:
  - [skill_shim.sh](scripts/skill_shim.sh) (macOS/Linux), or
  - [skill_shim.ps1](scripts/skill_shim.ps1) (Windows)
